	...
	const onFinishAddElectronics = async (values: any) => {
		...
		if (values.url && values.subCategory) {
			...
			Modal.error({
				title: 'Error',
				content:
					'Without product image you are not allowed to add a product',
			});
		}
	};
					...
					<Row>
						<Col span={12}>
							<div className="leftSideElectronics">
								...
								<Form.Item name="size">
									<Input placeholder="Size of the Product (Not Mandatory)" />
								</Form.Item>
									...
									rules={[
										{
											required: true,
											message:
												'Please input product Highlights!',
										},
									]}
								>
									<Input.TextArea
						...
						<Col span={12}>
							<div className="rightSideElectronics">
								...
								<Form.Item name="warranty">
									<Input placeholder="Warranty of the Product (Not Mandatory)" />
								</Form.Item>
									...
									rules={[
										{
											required: true,
											message:
												'Please input country of Origin!',
										},
									]}
								>
									...
									rules={[
										{
											required: true,
											message:
												'Please input product Specifications!',
										},
									]}
								>
									<Input.TextArea
									...
									rules={[
										{
											required: true,
											message:
												'Please input product manufacturer!',
										},
									]}
								>
									<Input.TextArea
